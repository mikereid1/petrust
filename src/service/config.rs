use actix_web::web;
use crate::service::pet::{create_pet, delete_pet, get_pet, update_pet};

use crate::service::store::{create_order, delete_order, get_inventory, get_order};
use crate::service::user::{create_user, delete_user, get_user, login, logout, update_user};
